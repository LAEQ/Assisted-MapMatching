...
class PathLayer:
    ...
    def speed_point_matching(self,matching, speed_column_name = "speed"):
        ...
        newpts = matching.snap_points_along_line(speedField = speed_column_name, speedlim=1.5 , minpts = 5 , maxpts = float("inf"))
        if newpts == -1:
            print("Error in matching.snap_points_along_line")
            return 
    ...
    def closest_point_matching(self, matching):
        """ Match the point in the path layer to a line by taking into account the speed
        ...
        layer = matching.snap_point_to_closest()

        if layer == -1:
            print("Error in matching.closest_point_matching")
            return
    ...
    def distance_point_matching(self, matching):
        """ Match the point in the path layer to a line by taking into account the speed
        ...
        layer = matching.snap_point_by_distance()
