...
class Layers:
    """ This class manage and coordinate the operations between the path and the network layer

    It is used by the principal class of the plugin: map_matching.py
    Parameters:

    path_layer: An object of class PathLayer
    network_layer: An object of class NetworkLayer
    """
    ...
    def get_polyline(self):
        ...
        mem_layer = from_list_of_dict_to_layer(temp, mem_layer, name="Polyline")
