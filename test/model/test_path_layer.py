...
class TestPathLayer(unittest.TestCase):
    ...
    def test_merge_stationary_point(self):
        ...
        self.assertEqual("negative.speed.limit", result)

        #inexisting speed column name
        result = self.path_layer.merge_stationary_point("test", 1)
        self.assertEqual("path.merge_stationary_point.wrong.speed.column", result)
    ...
    def test_speed_point_matching(self):
        ...
        self.assertEqual("speed.matching",result)
        ...
        self.assertEqual("wrong.speed.column",result)
    ...
    def test_closest_point_matching(self):
        ...
        self.assertEqual("closest.matching", result)
